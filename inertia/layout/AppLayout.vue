...
<template>
  <div class="min-h-screen flex flex-col bg-gray-100 text-gray-800">
    <!-- Header (Navbar) -->
     <header class="fixed top-0 left-0 w-full z-40 bg-black text-white flex items-center justify-between px-8 py-4 shadow-md">
   ...
   <main class="flex-grow relative overflow-hidden bg-gray-900 pt-24">
  <Transition
